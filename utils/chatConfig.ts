...
/** Keep chat images small so WS delivery stays reliable; history weight lives in IndexedDB. */
export const BACKEND_MAX_WS_IMAGE_DATA_URL_LENGTH = 512 * 1024
export const CHAT_HISTORY_MAX_MESSAGES_PER_PEER = 200
